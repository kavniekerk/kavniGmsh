...
// gf_x_wire.geo
// -----------------
// A wire with no end caps parallel to x.
// 
// ---------------------------------------------------------------------
// Parameters
// ---------------------------------------------------------------------
...
Function gf_x_wire
  ...
  //list of points
  c_p1 = newp; Point(c_p1) = {x0-c_l/2, -c_r + y0, 0   + z0, c_lc};
  c_p2 = newp; Point(c_p2) = {x0-c_l/2, 0    + y0, c_r + z0, c_lc};
  c_p3 = newp; Point(c_p3) = {x0-c_l/2, c_r  + y0, 0   + z0, c_lc};
  c_p4 = newp; Point(c_p4) = {x0-c_l/2, 0    + y0, -c_r+ z0, c_lc};
 ...
 // *******************************
  ...
  //list of points
  c_p5 = newp; Point(c_p5) = {x0+c_l/2, -c_r + y0, 0   + z0, c_lc};
  c_p6 = newp; Point(c_p6) = {x0+c_l/2, 0    + y0, c_r + z0, c_lc};
  c_p7 = newp; Point(c_p7) = {x0+c_l/2, c_r  + y0, 0   + z0, c_lc};
  c_p8 = newp; Point(c_p8) = {x0+c_l/2, 0    + y0, -c_r+ z0, c_lc};
...
c_out1[] = Extrude{{1,0,0},{x0,y0,z0},Pi/2}{Line{c_l1};};
c_out2[] = Extrude{{1,0,0},{x0,y0,z0},Pi/2}{Line{c_l2};};
c_out3[] = Extrude{{1,0,0},{x0,y0,z0},Pi/2}{Line{c_l3};};
c_out4[] = Extrude{{1,0,0},{x0,y0,z0},Pi/2}{Line{c_l4};};
