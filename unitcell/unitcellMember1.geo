...
a = 0.1;                                      // the "pitch", or distance between GEM pillars, in mm

mwf = 1;                                      // mesh_window_factor

mm = 1;                                       // geometrical scaling
r_w = 0.020 * mm;                             // radius of Wiremesh, in microns
...
mesh_level = 0.10;                            // mesh level, in mm
...
p0_1b = newp;     Point(p0_1b)    = {-p+p,-p+p,-r_w+mesh_level*mm-h_f, LcWiremesh * mm};          // centre circle
p1b_1_1 = newp;   Point(p1b_1_1)  = {-p+p,-p+p,-2*r_w+mesh_level*mm-h_f, LcWiremesh * mm};        // bottom circle
p2_1b = newp;     Point(p2_1b)    = {-p+p,r_w - p+p,-r_w+mesh_level*mm-h_f, LcWiremesh * mm};     // right circle
p1b_3_1 = newp;   Point(p1b_3_1)  = {-p+p,-p+p,0+mesh_level*mm-h_f, LcWiremesh * mm};             // top circle
// p4_1b = newp;  Point(p4_1b)    = {-p+p,-r_w - p+p,-r_w+mesh_level*mm-h_f, LcWiremesh * mm};    // left circle
...
p0_2a = newp;     Point(p0_2a)    = {p+p,p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};             // centre circle
p2a_1_1 = newp;   Point(p2a_1_1)  = {p+p,p+p,2*r_w+mesh_level*mm+h_f, LcWiremesh * mm};           // bottom circle
// p2_2a = newp;  Point(p2_2a)    = {p+p+r_w,p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};         // right circle
p2a_3_1 = newp;   Point(p2a_3_1)  = {p+p,p+p,0+mesh_level*mm+h_f, LcWiremesh * mm};               // top circle
p4_2a = newp;     Point(p4_2a)    = {p+p-r_w,p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};         // left circle
...
p0_2b = newp;     Point(p0_2b)    = {-p+p,-p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};           // centre circle
p2b_1_1 = newp;   Point(p2b_1_1)  = {-p+p,-p+p,2*r_w+mesh_level*mm+h_f, LcWiremesh * mm};         // bottom circle
p2_2b = newp;     Point(p2_2b)    = {-p+p+r_w,-p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};       // right circle
p2b_3_1 = newp;   Point(p2b_3_1)  = {-p+p,-p+p,0+mesh_level*mm+h_f, LcWiremesh * mm};             // top circle
// p4_2b = newp;  Point(p4_2b)    = {-p+p-r_w,-p+p,r_w+mesh_level*mm+h_f, LcWiremesh * mm};       // left circle
